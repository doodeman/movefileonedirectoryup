...
#This function is borrowed from the excellent article at: http://sbirch.net/tidbits/context_menu.html
...
oldpath = currentPath + "\\" + "mfodu.exe"
newpath = installPath + "\\" + "mfodu.exe"
shutil.copyfile(oldpath, newpath)
define_action_on("*", "MoveOneDirectoryUp", newpath + " \"%1\"", title="Move one directory up")
